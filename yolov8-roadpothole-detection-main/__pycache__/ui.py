...
try:
    background_image = Image.open(
        r"C:\Users\Amey\OneDrive\Desktop\Final_Lane_Detection_Project\yolov8-roadpothole-detection-main\bgimages\bgo3.jpg")
...
# Button for stopping detection
#stop_button = tk.Button(middle_frame, text="Stop Detection", command=stop_detection, width=20, height=2, bg="#007bff",
                        #fg="white", bd=0, relief=tk.FLAT, font=("Arial", 12, "bold"), cursor="hand2")
#stop_button.pack(pady=10)
