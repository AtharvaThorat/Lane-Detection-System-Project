    ...
    try:
        ...
        while True:
            ...
            if count % 50 == 0 and pothole_detected:
                ...
                cursor.execute('''INSERT INTO images (image_data, screenshot_path) VALUES (?, ?)''',
...
def run_combined_detection():
    pothole_video_path = "/Users/atharvathorat/Desktop/6th March/Final_Lane_Detection_Project/yolov8-roadpothole-detection-main/ALL_VIDEOS/p.mp4"
